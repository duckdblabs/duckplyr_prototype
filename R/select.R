...
select.data.frame <- function(.data, ...) {
  select.duckdb_relation(duckdb::rel_from_df(get_default_duckdb_connection(), .data), ...)  
}

#' @export
select.duckdb_relation <- function(.data, ...) {
  dots <- dplyr_quosures(...)
    select_expr <- list()
# TODO this is duplicated with mutate, maybe unify this
  ...
  duckdb::rel_project(.data, select_expr)
}
